            ...
            body: Stack(
              ...
              children: [
                ...
                Align(
                  child: Container(
                    child: PageIndicator(),
                    margin: EdgeInsets.only(bottom: 15 * heightMultiplier),
                  ),
                ...
                Align(
                  alignment: Alignment.bottomCenter,
                  child: Container(
                    margin: EdgeInsets.only(bottom: 5 * heightMultiplier),
                    child: ColoredButton(text: "Get Started", function: () {
                      Navigator.of(context, rootNavigator: true).pushReplacementNamed(RegisterScreen.routeName);
                    }),
